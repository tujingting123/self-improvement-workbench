...
const Views = {
  ...
  // ===== 5. 财经内容 =====
  // 理财知识学习（每日自动推荐，基于SheRises新女性成长学院理念）
  renderFinanceKnowledge(container) {
    ...
    const knowledgeDB = [
      // ===== 股票基础 =====
      { title: '什么是股票？一分钟搞懂',
        desc: '股票就是公司的所有权凭证。买股票等于成为公司股东，公司赚钱了你分钱（分红），公司增值了你卖出赚差价。',
        detail: '股票的本质是"所有权"。比如茅台总股本约12.6亿股，你买100股，你就是茅台12.6亿分之一的股东。\n\n【交易规则】A股一手=100股，最少买一手。交易时间：工作日9:30-11:30、13:00-15:00。\n\n【赚钱方式】①分红：公司把利润分给股东（如茅台2023年每股分红约30元）；②差价：低价买高价卖。\n\n【股票代码】沪市60开头（如贵州茅台600519），深市00/30开头（如宁德时代300750）。\n\n💡小贴士：新手建议从自己熟悉的行业入手，比如你每天用的产品是哪家公司做的，就去研究它。',
        tags: ['股票', '基础概念'] },
      { title: 'A股、港股、美股，傻傻分不清？',
        desc: 'A股=人民币交易、T+1、有涨跌停；港股=港币、T+0、无涨跌停；美股=美元、T+0、无涨跌停。新手从A股开始最稳妥。',
        detail: '三大市场核心区别：\n\n【A股（沪深）】\n• 货币：人民币\n• 交易规则：T+1（今天买，明天才能卖）\n• 涨跌停：主板±10%，创业板/科创板±20%\n• 交易费：佣金约万2.5，印花税0.05%（卖出时收）\n• 代表公司：茅台、宁德时代、比亚迪\n\n【港股】\n• 货币：港币\n• 交易规则：T+0（当天买卖），无涨跌停\n• 代表公司：腾讯、美团、阿里巴巴\n• 注意：有"仙股"风险（股价<1港元的垃圾股）\n\n【美股】\n• 货币：美元\n• 交易规则：T+0，无涨跌停\n• 代表公司：苹果、特斯拉、英伟达\n• 注意：时差问题（北京时间晚上9:30开盘）\n\n💡小贴士：新手建议A股起步，熟悉后再考虑港股和美股。',
        tags: ['股票', '市场区别'] },
      { title: 'PE（市盈率）—— 估值最常用的指标',
        desc: 'PE = 股价 ÷ 每股收益。PE=10代表10年回本。但PE低≠便宜，PE高≠贵，要和同行业比。',
        detail: '市盈率（Price to Earnings）= 你愿意为每1元利润付多少钱。\n\n【三种PE】\n• 静态PE = 股价 ÷ 去年每股收益（看过去）\n• 滚动PE（TTM）= 股价 ÷ 最近4个季度收益（看现在）★最常用\n• 动态PE = 股价 ÷ 预测未来收益（看未来）\n\n【怎么判断？】\n• PE<10：可能被低估（也可能是夕阳行业，如银行）\n• PE 10-20：合理区间（大多数成熟公司）\n• PE 20-50：成长型公司（如科技、医药）\n• PE>50或负数：高风险（亏损公司PE为负）\n\n【关键原则】PE只能同行业比较！银行PE=5很正常，科技PE=30也很正常，跨行业比没有意义。\n\n💡举例：茅台PE约30倍，工商银行PE约5倍，不是说工行更"便宜"，而是两个行业估值逻辑完全不同。',
        tags: ['股票', '估值', 'PE'] },
      { title: 'PB（市净率）—— 看资产值多少钱',
        desc: 'PB = 股价 ÷ 每股净资产。PB<1叫"破净"，意味着股价比公司净资产还低。银行股PB常低于1。',
        detail: '市净率（Price to Book）= 市场给公司净资产的"溢价倍数"。\n\n【计算公式】PB = 每股股价 ÷ 每股净资产\n\n【怎么判断？】\n• PB<1（破净）：股价比净资产还低，常见于银行、钢铁等重资产行业\n• PB 1-3：正常范围\n• PB>5：市场给了很高的溢价（通常是有品牌、技术等"无形资产"）\n\n【适用于哪些行业？】\n✅ 适用：银行、保险、地产、钢铁（资产主要是"硬货"）\n❌ 不适用：互联网、软件、医药（资产主要是人、技术、品牌，不在账面上）\n\n【经典案例】巴菲特投资富国银行时，PB仅0.8倍，后来涨到2倍以上。\n\n💡小贴士：PB和PE结合使用更准确。低PE+低PB=可能真的被低估了。',
        tags: ['股票', '估值', 'PB'] },
      { title: 'ROE（净资产收益率）—— 巴菲特最爱的指标',
        desc: 'ROE = 净利润 ÷ 净资产，代表公司用股东的钱赚了多少。ROE>15%算优秀，>20%算卓越。',
        detail: 'ROE是巴菲特选股的第一筛选标准。它回答了一个问题：公司每用股东100块钱，一年能赚多少钱？\n\n【杜邦分析法拆解ROE】\nROE = 净利率 × 资产周转率 × 杠杆倍数\n①净利率 = 净利润÷营收（赚钱效率）\n②周转率 = 营收÷总资产（运营效率）\n③杠杆 = 总资产÷净资产（借了多少钱）\n\n【怎么判断？】\n• ROE>20%：卓越（茅台约30%，苹果约150%）\n• ROE 15-20%：优秀\n• ROE 10-15%：一般\n• ROE<10%：较差\n\n【警惕"假高ROE"】\n如果ROE高是靠大量借钱（杠杆倍数高），风险很大！比如某些房地产公司ROE很高，但负债率90%+。\n\n💡筛选技巧：找连续5年以上ROE>15%的公司，大概率是好公司。A股约3700家公司中，符合这个条件的不到200家。',
        tags: ['股票', 'ROE', '财务指标'] },
      { title: '股息率—— 你买的股票每年"发多少红包"',
        desc: '股息率 = 每股分红 ÷ 股价。比如10元的股票分红0.5元，股息率=5%，超过银行理财。',
        detail: '股息率是衡量"现金回报"的指标，对于追求稳定现金流的投资者特别重要。\n\n【计算公式】股息率 = 年度每股分红 ÷ 当前股价 × 100%\n\n【怎么判断？】\n• >5%：高股息（如部分银行股、煤炭股）\n• 3-5%：中等股息（如电力、高速公路）\n• 1-3%：低股息（如成长型公司）\n• 不分红：很多科技公司利润再投资，不分红\n\n【分红的重要日期】\n• 股权登记日：这天收盘时持有股票的股东才有分红资格\n• 除权除息日：股价会下调（扣除分红金额），这天之后买的不参与本次分红\n• 派息日：现金到账的日子\n\n【注意】分红后股价会除权，短期看总资产不变。但长期看，持续高分红说明公司真的在赚钱。\n\n💡案例：中国神华2023年每股分红约2.5元，按当时股价25元算，股息率高达10%！',
        tags: ['股票', '股息', '分红'] },
      // ===== 基金基础 =====
      { title: '基金到底是什么？一篇文章讲明白',
        desc: '基金=把大家的钱集中起来，交给专业基金经理去投资。100元起投，比买股票门槛低得多。',
        detail: '基金就像一个"投资团购"——你出一点钱，我出一点钱，凑成一大笔钱交给专业的人去投资。\n\n【基金的三方角色】\n• 投资者（你）：出钱，享受收益（也承担亏损）\n• 基金公司：管理基金，收管理费（每年约0.5%-1.5%）\n• 托管银行：保管资金，防止基金公司挪用\n\n【基金的分类】\n按投资对象分：股票基金、债券基金、混合基金、货币基金\n按管理方式：主动基金（经理选股）、指数基金（跟踪指数）\n按交易方式：普通基金（按净值申赎）、ETF（交易所实时交易）\n\n【怎么看一只基金？】\n①基金代码（如510300=沪深300ETF）\n②单位净值（每份值多少钱）\n③成立以来收益（长期业绩）\n④基金经理（谁在管钱）\n⑤基金规模（太大太小都不好）\n\n💡小贴士：新手从指数基金开始，费用低、简单透明。',
        tags: ['基金', '基础概念'] },
      { title: '指数基金 vs 主动基金，到底选哪个？',
        desc: '指数基金=跟踪指数，被动复制，费率低。主动基金=经理选股，费率较高，依赖经理能力。巴菲特推荐指数基金。',
        detail: '这是投资界最有名的争论。我们用数据说话。\n\n【指数基金】\n✅ 优点：费率低（0.15%-0.5%/年）、完全透明、不受经理离职影响\n❌ 缺点：只能获得市场平均收益，不会"跑赢大盘"\n📊 代表：沪深300ETF（510300）、标普500ETF（SPY）\n\n【主动基金】\n✅ 优点：有机会跑赢市场，优秀经理能创造超额收益\n❌ 缺点：费率高（1%-1.5%/年）、经理可能离职、风格可能漂移\n📊 代表：富国天惠（朱少醒）、易方达蓝筹（张坤）\n\n【数据说话】\n美国标普公司统计：10年间85%的主动基金跑输了指数。\nA股因为散户多，主动基金跑赢指数的比例更高（约40-50%）。\n\n【巴菲特的赌约】\n2007年巴菲特公开打赌：10年内指数基金收益将超过任何对冲基金组合。2017年结果：指数基金年化7.1%，对冲基金仅2.2%。\n\n💡建议：核心仓位配指数基金（稳），卫星仓位配主动基金（博超额收益）。',
        tags: ['基金', '指数基金', '主动基金'] },
      { title: '沪深300、中证500、创业板指—— 三大指数全解析',
        desc: '沪深300=大盘蓝筹，中证500=中盘成长，创业板指=科技成长。三个指数搭配，覆盖不同风格。',
        detail: '这三个指数是A股最重要的"尺子"，理解它们就理解了A股的结构。\n\n【沪深300】\n• 成分：A股市值最大、流动性最好的300家公司\n• 行业：金融（20%）、食品饮料（12%）、电子（10%）\n• 特点：大盘蓝筹，波动较小，股息较高\n• 代表基金：510300（华泰柏瑞沪深300ETF）\n• 近10年年化收益：约6-8%\n\n【中证500】\n• 成分：排沪深300之后、市值301-800名的公司\n• 行业：医药（12%）、电子（10%）、电力设备（9%）\n• 特点：中盘成长，弹性更大\n• 代表基金：510500（南方中证500ETF）\n\n【创业板指】\n• 成分：创业板市值最大的100家公司\n• 行业：电力设备（30%+）、医药（20%+）、电子（10%+）\n• 特点：科技成长，波动大，涨跌猛\n• 代表基金：159915（易方达创业板ETF）\n\n💡建议：沪深300+中证500=覆盖A股前800名，是非常经典的组合。',
        tags: ['基金', '指数', '沪深300'] },
      { title: '基金定投—— 普通人最靠谱的投资方式',
        desc: '定投=每月固定日期投固定金额。市场跌时多买、涨时少买，长期成本被平均。定投沪深300超5年，盈利概率>90%。',
        detail: '基金定投是"懒人投资法"，但效果出奇的好。\n\n【定投为什么有效？】\n假设每月定投1000元：\n• 第一个月净值1.0→买1000份\n• 第二个月跌到0.8→买1250份（买得更多！）\n• 第三个月涨到1.2→买833份（买得更少）\n平均成本=3000÷3083=0.973元，比算术平均价1.0还低！\n\n【定投实操】\n①选标的：沪深300指数基金（推荐）\n②定频率：每月10号（发工资后）\n③定金额：月收入的10-20%\n④坚持：至少3-5年，不要中途停止\n\n【定投什么时候卖？】\n设一个止盈目标（如盈利20%或30%），达到后分批卖出。\n然后重新开始下一轮定投。\n\n【最大忌讳】❌市场大跌时因为害怕而停止定投——这时候恰恰是捡便宜的好时机！\n\n💡数据：从2004年至今，任意时间开始定投沪深300并坚持5年以上，盈利概率超过90%。',
        tags: ['基金', '定投'] },
      { title: 'A类和C类基金—— 选错了多花不少钱',
        desc: 'A类=买入收申购费，长期持有划算。C类=不收申购费，按天收服务费，短期持有划算。持有超1年选A类。',
        detail: '同一只基金经常有A类和C类两个版本，投资标的完全相同，区别只在收费方式。\n\n【A类份额】\n• 申购费：0.1%-0.15%（平台打折后，原价1%-1.5%）\n• 赎回费：持有<7天=1.5%（惩罚性），7天-1年=0.5%，1-2年=0.25%，>2年=0%\n• 无销售服务费\n\n【C类份额】\n• 无申购费\n• 赎回费：持有<7天=1.5%，>7天=0%\n• 销售服务费：0.4%-0.8%/年（按天扣）\n\n【怎么选？】\n• 持有<1年 → 选C类（省申购费）\n• 持有>1年 → 选A类（省服务费）\n• 定投 → 选A类（长期持有，A类更划算）\n\n【举例】投资1万元，持有1年：\n• A类：申购费15元+赎回费0元=15元\n• C类：服务费40元（0.4%×1年）=40元\nA类比C类省25元。如果持有不到3个月，C类更划算。\n\n💡小贴士：定投选A类，短期操作选C类。',
        tags: ['基金', '费率'] },
      // ===== 复利与投资理念 =====
      { title: '复利—— 世界第八大奇迹',
        desc: '复利=利滚利。10万年化10%：10年→25.9万，20年→67.3万，30年→174.5万。时间越长，威力越大！',
        detail: '爱因斯坦说："复利是世界第八大奇迹。懂的人赚取它，不懂的人支付它。"\n\n【复利 vs 单利】\n单利：只在本金上计算利息\n复利：利息也产生利息（利滚利）\n\n【震撼的数字对比】本金10万，年化收益10%：\n• 第5年：单利=15万，复利=16.1万（差距不大）\n• 第10年：单利=20万，复利=25.9万（差5.9万）\n• 第20年：单利=30万，复利=67.3万（差37万！）\n• 第30年：单利=40万，复利=174.5万（差134万！！）\n\n【复利三要素】\n①本金：越多越好（努力攒钱）\n②收益率：越高越好（学习投资）\n③时间：越长越好（尽早开始！）\n\n【举个真实的例子】\n如果25岁开始每月定投2000元，年化10%：\n• 到35岁：约41万\n• 到45岁：约131万\n• 到55岁：约363万\n• 到65岁：约946万\n\n💡复利的秘诀不是"高收益"，而是"早开始+坚持"。',
        tags: ['复利', '长期投资'] },
      { title: '"72法则"—— 心算本金翻倍时间的秘诀',
        desc: '72 ÷ 年化收益率 = 本金翻倍所需年数。年化6%→12年翻倍，10%→7.2年翻倍，15%→4.8年翻倍。',
        detail: '72法则是投资中最实用的心算工具，不用计算器就能估算复利效果。\n\n【公式】翻倍年数 ≈ 72 ÷ 年化收益率（%）\n\n【速查表】\n• 年化4%（银行理财）→ 18年翻倍\n• 年化6%（债券基金）→ 12年翻倍\n• 年化8%（沪深300历史均值）→ 9年翻倍\n• 年化10%（优秀基金经理）→ 7.2年翻倍\n• 年化15%（巴菲特级别）→ 4.8年翻倍\n• 年化20%（顶尖投资者）→ 3.6年翻倍\n\n【延伸应用】\n同样适用于计算通胀：\n如果通胀率3%，72÷3=24年后你的钱购买力减半。\n\n同样适用于计算GDP翻倍：\n如果GDP增速5%，72÷5=14.4年经济总量翻倍。\n\n【反过来用】\n如果你想10年翻倍，需要多少年化收益？\n72÷10=7.2%的年化收益。\n\n💡这个公式说明：收益率提高一点点，长期效果天差地别。多学一点投资知识，提升哪怕1-2%的年化收益，几十年后就是百万级的差距。',
        tags: ['复利', '72法则'] },
      { title: '为什么90%的散户都亏钱？',
        desc: '频繁交易+追涨杀跌=散户亏损公式。沪深300长期年化8-10%，但散户平均年化-2%。秘诀：少看盘、少交易、长期持有。',
        detail: '这不是危言耸听，而是真实数据。\n\n【清华五道口研究数据】\n2016-2019年，A股散户平均年化收益：-2.03%\n同期沪深300年化收益：+8.2%\n\n【散户亏钱的五大原因】\n①频繁交易：平均持股不到40天，手续费吃掉大半利润\n②追涨杀跌：看到涨了冲进去，看到跌了恐慌卖出\n③听消息炒股：群里推荐的、大V说的、朋友介绍的...\n④不看估值：PE100倍也敢买，觉得"还会涨"\n⑤不止损：亏了不卖，越套越深，最后割在最低点\n\n【赚钱的散户怎么做？】\n• 持股时间>1年\n• 只买自己研究过的公司\n• 市场大跌时加仓\n• 不盯盘，不频繁操作\n\n【行为金融学解释】\n亏损1万元的痛苦 ≈ 赚2万元的快乐。\n这种"损失厌恶"让散户在下跌时恐慌卖出，错过反弹。\n\n💡巴菲特说："股市是把钱从没耐心的人转移到有耐心的人身上的机器。"',
        tags: ['投资心理', '散户'] },
      // ===== 宏观经济 =====
      { title: 'GDP、CPI、PMI —— 三个最关键的宏观指标',
        desc: 'GDP=经济总量，CPI=物价指数(通胀)，PMI=制造业景气度(>50扩张)。这三个数据决定央行的政策方向。',
        detail: '这三个指标是判断经济"冷热"的体温计，投资者必须了解。\n\n【GDP（国内生产总值）】\n• 含义：一个国家一年内生产的所有最终产品和服务的总价值\n• 中国2025年GDP约130万亿，增速目标5%左右\n• >5%：经济过热，可能加息\n• <5%：经济偏冷，可能降息刺激\n• 每季度公布一次\n\n【CPI（居民消费价格指数）】\n• 含义：衡量一篮子商品和服务的价格变化\n• >3%：通胀偏高，央行可能加息\n• <0%：通缩，经济需求不足\n• 理想区间：1-3%\n• 每月公布一次\n\n【PMI（采购经理指数）】\n• 含义：通过对企业采购经理的问卷调查编制\n• >50：制造业在扩张（经济好）\n• <50：制造业在收缩（经济差）\n• 是经济的"先行指标"，比其他数据早1-2个月\n• 每月最后一天公布\n\n💡小贴士：关注每月PMI数据，它是最快的经济晴雨表。',
        tags: ['宏观经济', 'GDP', 'CPI'] },
      { title: '加息和降息—— 央行的"油门和刹车"',
        desc: '加息=收紧钱袋子，股市偏利空；降息=放松钱袋子，股市偏利好。但市场会提前反应，降息当天不一定会涨。',
        detail: '利率是央行调控经济最重要的工具。理解利率变化，就能理解资产价格的涨跌。\n\n【加息的影响】\n• 企业：借钱成本变高→减少投资→利润下降→股价跌\n• 个人：房贷利率涨→月供增加→消费减少\n• 债券：新债券利率更高→旧债券价格下跌\n• 汇率：人民币升值→外资流入→部分对冲股市下跌\n\n【降息的影响】\n• 企业：借钱成本降低→增加投资→利润增厚→股价涨\n• 个人：房贷利率降→月供减少→消费增加\n• 债券：旧债券利率更高→价格上涨\n• 汇率：人民币贬值→利好出口企业\n\n【"预期"比"行动"更重要】\n市场会提前3-6个月消化加息/降息预期。\n等央行真正宣布时，股价往往已经涨完或跌完了。\n所以要看"市场预期什么"，而不是"央行做了什么"。\n\n💡关注央行每个季度的《货币政策执行报告》，里面有未来政策方向的重要信号。',
        tags: ['宏观经济', '利率'] },
      { title: '人民币汇率和A股的关系',
        desc: '人民币升值→外资流入→A股利好。贬值→外资流出→利空（但利好出口企业）。汇率看美元指数和贸易顺差。',
        detail: '汇率和股市的关系，是很多新手忽略的重要变量。\n\n【传导机制】\n①人民币升值（如从7.3→6.8）\n→外资持有A股换回美元更值钱→外资流入→股市涨\n②人民币贬值（如从6.8→7.3）\n→外资持有A股换回美元贬值→外资流出→股市跌\n\n【北向资金】\n外资通过沪港通/深港通买卖A股的资金叫"北向资金"。\n北向资金每天流入/流出数据是重要的市场情绪指标。\n\n【哪些股票受影响最大？】\n• 外资重仓股（茅台、宁德时代等）→汇率影响大\n• 出口型企业（纺织、家电）→贬值反而利好\n• 内需型企业（酱油、白酒）→汇率影响小\n\n【怎么看汇率走势？】\n①美元指数：美元强→人民币弱\n②中美利差：中国利率高→人民币强\n③贸易顺差：出口多→人民币强\n\n💡每天关注"北向资金净流入/流出"，这是外资对A股态度的直接体现。',
        tags: ['宏观经济', '汇率'] },
      // ===== 实操策略 =====
      { title: '"核心+卫星"策略—— 最经典的资产配置方案',
        desc: '核心仓位70%配置沪深300+中证500指数基金，卫星仓位30%配置行业基金。每半年再平衡一次。',
        detail: '这个策略适合90%的普通投资者，简单但有效。\n\n【核心仓位（70%）】\n• 沪深300指数基金（40%）：大盘蓝筹，稳健底仓\n• 中证500指数基金（30%）：中盘成长，弹性收益\n→ 这部分追求市场平均收益，不折腾\n\n【卫星仓位（30%）】\n• 行业基金（科技/消费/医药）（20%）\n• 债券基金或现金（10%）：作为"弹药库"\n→ 这部分追求超额收益，可以灵活调整\n\n【再平衡—— 最被低估的操作】\n每半年检查一次：\n• 如果核心涨到了80%→卖掉一部分，补到卫星\n• 如果卫星跌到了20%→卖掉核心，补到卫星\n→ 这相当于"自动高抛低吸"！\n\n【不同年龄的配置建议】\n• 25-35岁：股票80%+债券20%（承受力强，追求增长）\n• 35-50岁：股票60%+债券40%（平衡增长与稳健）\n• 50岁以上：股票40%+债券60%（稳健为主，保本优先）\n\n💡这个策略的精髓在于"纪律"——不要因为市场涨跌改变配置比例。',
        tags: ['资产配置', '策略'] },
      { title: '什么时候该卖股票？三个卖出信号',
        desc: '①买入逻辑不再成立 ②找到更好的标的 ③配置比例严重偏离。市场跌了不是卖出的理由！',
        detail: '"会买的是徒弟，会卖的是师傅。"很多散户亏钱不是因为买错了，而是卖错了。\n\n【信号一：买入逻辑不再成立】\n例：你买入某公司是因为ROE>20%，现在ROE降到8%了→该卖\n例：你买入是因为行业高增长，现在行业见顶了→该卖\n→ 不是因为股价跌了就卖！\n\n【信号二：找到更好的投资机会】\n例：你持有A公司年化收益预期8%，发现B公司预期12%→换仓\n→ 但注意不要频繁换仓，至少持有半年以上再评估\n\n【信号三：配置比例严重偏离】\n例：某股票从占你仓位的10%涨到30%了→卖出一部分\n→ 这是"再平衡"，不是不看好，而是控制风险\n\n【什么不是卖出信号？】\n❌ 市场大跌了（应该考虑加仓）\n❌ 朋友说这只股票不行了（你买的时候研究过吗？）\n❌ 已经赚了20%了（好公司可以一直持有）\n❌ 已经亏了15%了（亏损不是卖出的理由，逻辑变了才是）\n\n💡巴菲特持有可口可乐35年+，期间经历过多次50%以上的回撤，但从未卖出。',
        tags: ['卖出策略', '止盈止损'] },
      { title: '仓位管理—— 永远不要满仓',
        desc: '满仓=没有子弹补仓。至少留20%现金。市场大跌时有钱加仓，心态更好。100-年龄=股票仓位%。',
        detail: '仓位管理是投资中最被低估的技能。控制好仓位，就控制住了风险。\n\n【为什么不能满仓？】\n①大跌时没钱补仓→错失捡便宜的机会\n②满仓心态差→一跌就慌，容易割在地板上\n③生活急用钱→被迫在不合适的时候卖出\n\n【仓位管理的"年龄法则"】\n股票仓位% = 100 - 你的年龄\n• 30岁：股票70%+债券/现金30%\n• 40岁：股票60%+债券/现金40%\n• 50岁：股票50%+债券/现金50%\n→ 年龄越大，越经不起大跌，股票占比应该越低\n\n【金字塔加仓法】\n不要在股价高点重仓！\n• 估值合理时：建仓30%\n• 跌10%：加仓20%\n• 跌20%：加仓30%\n• 跌30%：加仓最后的20%\n→ 成本越来越低，反弹后盈利空间更大\n\n💡永远给自己留"子弹"。巴菲特账上常年趴着1000亿美元以上的现金，等待机会。',
        tags: ['仓位管理', '风险控制'] },
      { title: '可转债—— "下有保底，上不封顶"的投资品种',
        desc: '可转债=债券+股票期权。股价涨了转股赚钱，跌了至少拿回本金+利息。打新债1000元起，中签率比新股高。',
        detail: '可转债是A股特有的"进可攻退可守"的投资工具，非常适合风险偏好中等的投资者。\n\n【可转债的"双重身份"】\n①债券属性：面值100元，到期还本付息（保底）\n②股票属性：可以按约定价格转换成股票（进攻）\n\n【怎么赚钱？】\n方式一：打新债→上市首日卖出\n• 门槛：有证券账户即可，不需要持有股票市值\n• 中一签=1000元\n• 上市首日通常有10-30%的涨幅\n• 中签率比新股高很多\n\n方式二：低价买入→等待转股或强赎\n• 在可转债价格<110元时买入\n• 等待股价上涨触发"强制赎回"（通常130元以上）\n• 年化收益10-30%是常态\n\n【风险提示】\n• 可转债也可能违约（公司破产还不起钱）\n• 但历史上A股可转债违约极少\n\n💡打新债是新手参与可转债最简单的方式，每天关注"可转债申购日历"。',
        tags: ['可转债', '打新债'] },
      { title: '国债逆回购—— 闲置资金的"余额宝升级版"',
        desc: '把钱借给别人，对方用国债抵押。几乎零风险，年化1.5-4%。节假日前收益率飙升。1天期最灵活。',
        detail: '如果你账户里有暂时不用的闲钱（比如等待买入时机），国债逆回购是最佳去处。\n\n【是什么？】\n你通过交易所把钱借给需要资金的机构（如券商），对方用国债作为抵押品。因为抵押品是国债（国家信用），所以几乎零风险。\n\n【操作方式】\n在股票账户里找到"国债逆回购"→选择期限（1天/7天/14天等）→输入金额→确认。到期本金+利息自动回到账户。\n\n【代码速查】\n沪市：GC001（1天期）、GC007（7天期）\n深市：R-001（1天期）、R-007（7天期）\n门槛：深市1000元起，沪市10万元起\n\n【什么时候收益高？】\n• 月末、季末、年末（银行冲存款，资金紧张）\n• 春节、国庆长假前（大家都要用钱）\n• 周四做1天期=享受周五+周六+周日三天利息\n\n💡每周四下午做1天期逆回购，可以拿3天利息，周五资金还能用！',
        tags: ['债券', '逆回购', '现金管理'] },
    ];

    // 基于日期选择今日推荐（每天5条，顺序推进不重复）
    const totalItems = knowledgeDB.length;
    const startIdx = (dayOfYear * 5) % totalItems;
    const todayItems = [];
    for (let i = 0; i < 5; i++) {
      todayItems.push(knowledgeDB[(startIdx + i) % totalItems]);
    }

    const section = document.createElement('div');
    section.className = 'section-title';
    section.style.marginTop = '4px';
    section.innerHTML = '💰 理财知识学习 <span style="font-size:11px;font-weight:400;color:var(--text-muted);">— 每日5条 · 点击查看详情</span>';
    container.appendChild(section);
    ...
    todayItems.forEach((item, idx) => {
      ...
      card.innerHTML = `
        <div class="fk-header">
          <span class="fk-day">Day ${dayOfYear + idx}</span>
  ...
  renderKnowledgeBase(container) {
    ...
    const knowledgeDB = [
      ...
      // 视频剪辑
      { id: 'kw7', cat: '视频剪辑', title: '剪映关键帧入门', desc: '关键帧=记录某个时间点的画面状态。设置起始关键帧→移动时间轴→改变画面参数→自动生成动画。缩放、位移、旋转、透明度都能做动画。', tags: ['剪映', '关键帧', '入门'], target: 'editingItems', targetName: '视频剪辑' },
      { id: 'kw8', cat: '视频剪辑', title: '5种常用转场技巧', desc: '①硬切（最常用）②淡入淡出（抒情）③缩放转场（快节奏）④旋转转场（炫酷）⑤遮罩转场（高级）。新手先练硬切和淡入淡出。', tags: ['转场', '技巧'], target: 'editingItems', targetName: '视频剪辑' },
      { id: 'kw9', cat: '视频剪辑', title: '视频调色三板斧', desc: '①亮度/对比度：先调明暗 ②饱和度：控制色彩浓度 ③色温：冷色调=高级感，暖色调=温馨感。新手用剪映"调节"功能就够了。', tags: ['调色', '入门'], target: 'editingItems', targetName: '视频剪辑' },
      { id: 'kw10', cat: '视频剪辑', title: 'BGM选曲黄金法则', desc: '①音量不超过人声的30% ②节奏匹配剪辑节奏 ③高潮卡在视频最精彩处 ④热门BGM自带流量。推荐网站：Epidemic Sound、抖音热门音乐。', tags: ['BGM', '音乐'], target: 'editingItems', targetName: '视频剪辑' },
      { id: 'kw11', cat: '视频剪辑', title: '字幕制作规范', desc: '字体：黑体/思源黑体；大小：屏幕宽度的5%；位置：底部居中偏上；时长：每行2-6字/秒；颜色：白字黑边最清晰。剪映自动识别+手动修正。', tags: ['字幕', '规范'], target: 'editingItems', targetName: '视频剪辑' },
      { id: 'kw12', cat: '视频剪辑', title: '短视频节奏控制', desc: '前3秒决定留存率，必须放最吸引人的画面/问题。每5-10秒一个信息点或画面变化。总时长新手建议30-60秒，熟练后15-30秒。', tags: ['节奏', '短视频'], target: 'editingItems', targetName: '视频剪辑' },
      // 海报设计
      { id: 'kw13', cat: '海报设计', title: '排版四原则：CRAP', desc: 'Contrast（对比）：重要元素要突出；Repetition（重复）：统一字体/颜色；Alignment（对齐）：元素间有视觉联系；Proximity（亲密性）：相关内容放一起。', tags: ['排版', '设计原则'], target: 'posterItems', targetName: '海报制作' },
      { id: 'kw14', cat: '海报设计', title: '配色速成：60-30-10法则', desc: '60%主色（背景/大面积）、30%辅助色（重点区域）、10%强调色（按钮/关键文字）。推荐工具：Coolors.co 一键生成配色方案。', tags: ['配色', '法则'], target: 'posterItems', targetName: '海报制作' },
      { id: 'kw15', cat: '海报设计', title: '字体搭配黄金组合', desc: '标题用无衬线粗体（思源黑体/站酷快乐体），正文用衬线或细体（思源宋体）。一张海报不超过2种字体，通过大小/粗细/颜色区分层次。', tags: ['字体', '搭配'], target: 'posterItems', targetName: '海报制作' },
      { id: 'kw16', cat: '海报设计', title: '海报尺寸速查表', desc: '小红书：1080×1440(3:4)；朋友圈：1080×1260(6:7)；公众号封面：900×383(2.35:1)；手机海报：1080×1920(9:16)；横版海报：1920×1080(16:9)。', tags: ['尺寸', '规范'], target: 'posterItems', targetName: '海报制作' },
      { id: 'kw17', cat: '海报设计', title: '留白的艺术', desc: '留白≠空白，是设计呼吸感的关键。文字与边缘至少留10%边距；元素之间留白>元素本身大小；信息密度每张海报不超过3个重点。', tags: ['留白', '排版'], target: 'posterItems', targetName: '海报制作' },
      { id: 'kw18', cat: '海报设计', title: 'Canva快速出图流程', desc: '①搜索模板关键词 ②替换文字和图片 ③调整配色为你的品牌色 ④导出PNG。全程10分钟。适合非设计师快速出图。', tags: ['Canva', '工具'], target: 'posterItems', targetName: '海报制作' },
      // 英语学习
      { id: 'kw19', cat: '英语学习', title: '影子跟读法（Shadowing）', desc: '播放英语音频→延迟0.5秒跟读→模仿语音语调语速。每天15分钟，一个月口语流利度明显提升。推荐材料：EnglishPod、BBC 6 Minute English。', tags: ['口语', '跟读', '方法'], target: 'english', targetName: '英语' },
      { id: 'kw20', cat: '英语学习', title: '雅思口语Part2万能模板', desc: '开头：I\'d like to talk about...；描述：who/what/when/where；感受：how I felt / why it\'s important；结尾：That\'s pretty much what I wanted to say.', tags: ['雅思', '口语', '模板'], target: 'english', targetName: '英语' },
      { id: 'kw21', cat: '英语学习', title: '单词记忆：间隔复习法', desc: '新词→1小时后复习→1天后→3天后→7天后→30天后。用Anki或自制卡片。每天新词不超过20个，复习旧词比学新词更重要。', tags: ['单词', '记忆法'], target: 'english', targetName: '英语' },
      { id: 'kw22', cat: '英语学习', title: '英语听力提升路线图', desc: '第1月：精听EnglishPod（每天1期，听3遍）；第2-3月：泛听BBC/CNN（每天30分钟）；第4-6月：真题听力（剑桥雅思）。循序渐进，不要跳级。', tags: ['听力', '路线图'], target: 'english', targetName: '英语' },
      { id: 'kw23', cat: '英语学习', title: '英语写作：从模仿到独立', desc: '①精读一篇范文→分析结构→②用中文写提纲→③自己写英文→④对照原文修改→⑤总结好词好句。每周2篇，半年写作脱胎换骨。', tags: ['写作', '方法'], target: 'english', targetName: '英语' },
      // 理财投资
      { id: 'kw24', cat: '理财投资', title: '基金定投实操指南', desc: '①开户：支付宝/天天基金 ②选基：沪深300ETF联接（费率低）③设置：每月10号自动扣款 ④金额：月收入10-20% ⑤纪律：坚持3年以上，不要中途停止。', tags: ['定投', '实操'], target: 'finance', targetName: '财经' },
      { id: 'kw25', cat: '理财投资', title: '可转债打新全流程', desc: '①开通证券账户 ②每日查看"可转债申购日历" ③点击申购（顶格申购）④T+2公布中签 ⑤缴款1000元 ⑥上市首日卖出（通常盈利100-300元）。', tags: ['打新债', '实操'], target: 'finance', targetName: '财经' },
      { id: 'kw26', cat: '理财投资', title: '个人财务体检清单', desc: '每月1号检查：①应急金≥3个月支出？②负债/月收入<30%？③储蓄率≥20%？④投资组合是否需要再平衡？⑤保险是否齐全？', tags: ['财务体检', '清单'], target: 'finance', targetName: '财经' },
      { id: 'kw27', cat: '理财投资', title: '省钱不降生活品质的5个技巧', desc: '①取消不用的订阅会员 ②大额消费等24小时再决定 ③买品质好耐用的而非便宜的 ④自己做饭代替外卖 ⑤用信用卡积分换购。每月可省1000-3000元。', tags: ['省钱', '技巧'], target: 'finance', targetName: '财经' },
      // 效率工具
      { id: 'kw28', cat: '效率工具', title: '番茄工作法实操', desc: '①设25分钟倒计时→专注一件事 ②铃响休息5分钟 ③每4个番茄钟休息15-30分钟。工具：Forest App（种树）、番茄ToDo。每天8个番茄钟=高效4小时。', tags: ['番茄钟', '专注'], target: 'memos', targetName: '备忘录' },
      { id: 'kw29', cat: '效率工具', title: 'Notion搭建个人知识库', desc: '①创建Database ②设置属性：分类、标签、日期、状态 ③用不同视图：表格/看板/日历 ④模板化重复内容。推荐从PARA笔记法开始。', tags: ['Notion', '知识管理'], target: 'memos', targetName: '备忘录' },
      { id: 'kw30', cat: '效率工具', title: '每日复盘模板', desc: '①今天完成了什么？（3件事）②遇到了什么问题？③学到了什么？④明天最重要的1件事是什么？每天花5分钟，一年后你会感谢自己。', tags: ['复盘', '模板'], target: 'memos', targetName: '备忘录' },
    ];

    // 分类筛选
    const cats = [...new Set(knowledgeDB.map(k => k.cat))];
    let activeCat = 'all';
    ...
    const renderList = () => {
      listWrap.innerHTML = '';
      const filtered = activeCat === 'all' ? knowledgeDB : knowledgeDB.filter(k => k.cat === activeCat);
      filtered.forEach(item => {
        ...
        `;
        card.querySelector('.knowledge-add-btn').onclick = (e) => {
          e.stopPropagation();
